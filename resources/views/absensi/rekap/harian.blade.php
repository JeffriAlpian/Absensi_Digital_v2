...
@section('content')
    <div x-data="{ activeTab: 'guru' }" class="space-y-6">
        ...
        <div
            class="flex flex-col md:flex-row justify-between items-end bg-white p-5 rounded-xl shadow-sm border border-gray-100 gap-4">
            <div>
        ...
        <div class="flex space-x-2 border-b border-gray-200">
            <button @click="activeTab = 'guru'"
                ...
                <span
                    class="bg-gray-200 text-gray-600 text-[10px] px-2 py-0.5 rounded-full">{{ $statsGuru['total'] }}</span>
            </button>
            ...
            <button @click="activeTab = 'siswa'"
                ...
                <span
                    class="bg-gray-200 text-gray-600 text-[10px] px-2 py-0.5 rounded-full">{{ $statsSiswa['total'] }}</span>
            </button>
        </div>
    ...
    <style>
        ...
        .badge-gray {
            @apply bg-gray-100 text-gray-600 text-xs font-medium px-2.5 py-0.5 rounded border border-gray-200;
        }
    </style>
