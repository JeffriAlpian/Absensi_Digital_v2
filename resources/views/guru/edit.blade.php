...
<div class="flex-1 p-6">
    ...
    <a href="{{ route('guru.index') }}" class="inline-flex items-center text-gray-600 dark:text-[#A7A7A7] hover:text-gray-900 dark:text-white mb-6 transition">
            ...
            @method('PUT') <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nip" 
                           ...
                           @error('nip') border-red-500 ring-red-500 @else border-gray-300 dark:border-[#333333] @enderror"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="jabatan" 
                           ...
                           class="w-full border rounded-md px-3 py-2 focus:ring-green-500 focus:border-green-500
                           @error('jabatan') border-red-500 ring-red-500 @else border-gray-300 dark:border-[#333333] @enderror"
                ...
                <div>
                    ...
                    <input type="password" name="password" 
                           class="w-full border rounded-md px-3 py-2 focus:ring-green-500 focus:border-green-500
                           @error('password') border-red-500 ring-red-500 @else border-gray-300 dark:border-[#333333] @enderror"
