...
<div class="container mx-auto px-4 py-6 max-w-lg">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <h2 class="text-xl font-bold mb-6 text-gray-800 border-b pb-2">Ganti Wali Kelas</h2>
        ...
        <form action="{{ route('wakel.update', $wakel->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" value="{{ $wakel->kelas->nama_kelas }}" class="shadow border rounded w-full py-2 px-3 text-gray-500 bg-gray-100 cursor-not-allowed leading-tight focus:outline-none" disabled>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('wakel.index') }}" class="inline-block align-baseline font-bold text-sm text-gray-500 hover:text-gray-800">
                    Batal
                </a>
            </div>
        </form>
