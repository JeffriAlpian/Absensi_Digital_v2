...
<div class="container mx-auto px-4 py-6 max-w-lg">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <h2 class="text-xl font-bold mb-6 text-gray-800 border-b pb-2">Tugaskan Wali Kelas</h2>
        ...
        <form action="{{ route('wakel.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="kelas_id" id="kelas_id" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
