...
@section('content')
    <div class="bg-indigo-600 pt-8 pb-16 px-6 rounded-b-[2.5rem] relative z-10">
        <div class="flex items-center justify-between">
            ...
            <div class="w-12 h-12 rounded-full border-2 border-indigo-400 overflow-hidden bg-white">
    ...
    <div class="px-5 -mt-8 relative z-20">
        <div class="bg-white rounded-2xl shadow-lg p-5 flex justify-between items-center">
    ...
    <div class="px-5 mt-6 space-y-4">
        ...
        {{-- <div class="bg-white p-4 rounded-xl border-l-4 border-indigo-500 shadow-sm flex items-center justify-between">
            <div>
                <p class="font-bold text-gray-800 text-sm">Matematika Wajib</p>
                <p class="text-xs text-gray-500 mt-1"><i class="fa-regular fa-clock mr-1"></i> 07:30 - 09:00</p>
            </div>
            <span class="bg-indigo-50 text-indigo-600 text-[10px] font-bold px-2 py-1 rounded">X-RPL 1</span>
        </div> --}}

        <h3 class="font-bold text-gray-800 text-sm mt-6 mb-2">Menu Lainnya</h3>
        <div class="grid grid-cols-4 gap-3">
            <a href="{{route('dashboard.guru.scan.index')}}" class="flex flex-col items-center gap-2">
                <div class="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-green-500">
            ...
            <a href="{{route('dashboard.guru.manual.index')}}" class="flex flex-col items-center gap-2">
                ...
                <span class="text-[10px] text-gray-500">Laporan</span>
            </a>
            <a href="#" class="flex flex-col items-center gap-2">
                <div class="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-purple-500">
