...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-3xl mx-auto">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">Tambah Hari Libur</h2>
        ...
        <div class="bg-white dark:bg-[#181818] dark:text-white shadow rounded-lg p-6 space-y-5">
            ...
            <div>
                ...
                <input type="text" name="keterangan" id="keterangan" 
                       ...
                       value="{{ old('keterangan') }}" maxlength="100" placeholder="Misal: Hari Raya Idul Fitri">
                @error('keterangan')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
